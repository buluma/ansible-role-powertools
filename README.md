...
- pip packages listed in [requirements.txt](https://github.com/buluma/ansible-role-powertools/blob/main/requirements.txt).
...
[RMichael Buluma](https://buluma.github.io/)
